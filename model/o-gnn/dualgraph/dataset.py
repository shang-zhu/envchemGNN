...
class DGPygPCQM4MDataset(PygPCQM4Mv2Dataset):
    def __init__(self, root='dataset', file_name='pcqm4m-v2', smiles2graph=None, transform=None, pre_transform=None):
        super().__init__(
            root=root, file_name=file_name, smiles2graph=smiles2graph, transform=transform, pre_transform=pre_transform
        )
