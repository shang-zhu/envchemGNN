...
#SBATCH -e feat_bcf_%j.err
#SBATCH -o feat_bcf_%j.out # File to which STDOUT will be written %j is the job #
...
model_path='/ocean/projects/cts180021p/shang9/molecules/pretrainLCA/finalized/model/o-gnn/result/BCF/model_0.pt'
for csv_name in 'BCF' 
    do
